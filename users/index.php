...
$query_users = mysqli_query($conn, "SELECT * FROM users LIMIT $offset,$records_per_page");
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?= $users["email"]; ?></td>
                    <td>
                      <a href="./update.php?id=<?= $users['id']; ?>" class="btn btn-primary">Perbarui</a>
                      <a onclick="return confirm('Apakah anda ingin menghapus data?')" href="index.php?delete=<?= $users['id']; ?>" class="btn btn-danger">Hapus</a>
                      <a href="./change_pw.php?id=<?= $users['id']; ?>" class="btn btn-primary">Perbarui Password</a>
                    </td>
                  </tr>
                <?php endwhile; ?>
              </tbody>
