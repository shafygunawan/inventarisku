...
$count_query = mysqli_query($conn, "SELECT COUNT(*) AS total FROM out_h");
...
$query_barang = mysqli_query($conn, "SELECT * FROM out_h ORDER BY id DESC LIMIT $offset,$records_per_page");
