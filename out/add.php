...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  mysqli_query($conn, "CALL proc_out_add('$date', '$item_ids', '$quantities', @out_h_id)");

  $result = mysqli_query($conn, "SELECT @out_h_id AS out_h_id");
  $out_h_id = mysqli_fetch_assoc($result)['out_h_id'];

  echo "<script>
    alert('Transaksi keluar berhasil disimpan!');
    window.location.href = './details.php?id=$out_h_id';
  </script>";
